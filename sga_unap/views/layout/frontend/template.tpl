        ...
        <header class="container">
            <div class="row">
                <div class="col col-md-3 col-sm-2 col-xs-3 padding-10">
                    <img  class="width-250" src="{$_layoutParams.ruta_img}logo_unap.jpg" alt="UNAP" title="UNAP">
                </div>
                <div class="col col-md-6 col-sm-8 col-xs-6 hidden-xs  texto-header  border-left-1 txt-color-grey padding-l-10">
                    <h2 class="txt-color-black display-block text-bold ">Sistema de Gestión Docentes de la Universidad Nacional de la Amazonía Peruana</h2>
                    
                </div>       
                <div class="col col-md-3 col-sm-2 col-xs-3 padding-10 text-align-right" >
                    <img src="{$_layoutParams.ruta_img}logo_fisi.jpg" style="max-height: 130px">
                </div>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="display-block margin-t-10">
                                  <a href="#" class="display-inline">
                                      <img class="img-responsive max-height-60" src="{$_layoutParams.ruta_img}logo_minedu.jpg">
                                ...
                                <div class="display-block margin-t-10">
                                    ...
                                    <a href="#" class="display-inline">
                                      <img class="img-responsive max-height-60" src="{$_layoutParams.ruta_img}logo_iiap.jpg">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6 text-align-r">
                                ...
                                <div class="text-footer">
                                    ...
                                    Sargento Lores 385, Iquitos, Perú.  <br>
                                    Información, noticias y comentarios:
                                    infounap@unapiquitos.edu.pe <br>
                                    Teléfono: (51-65) 232186 <br>
                                    © Copyright 2018 - UNAP <br>
                                </div>
                                <h5 class="text-bold">SÍGUENOS</h5>
                                <div class="text-footer">                                   
                                     <a class="display-block" href="http://www.unapiquitos.edu.pe/ ">http://www.unapiquitos.edu.pe </a>
                                     <a class="ic_sociales" href="https://facebook.com/unap.iquitos" target="_blank"><img class="img-responsive" src="{$_layoutParams.ruta_img}frontend/ic_fb.png"></a>
                                     <a class="ic_sociales" href="https://twitter.com/unapiquitos" target="_blank"><img class="img-responsive" src="{$_layoutParams.ruta_img}frontend/ic_tw.png"></a>
                                     <a class="ic_sociales" href="https://www.youtube.com/user/unapiquitos" target="_blank"><img class="img-responsive" src="{$_layoutParams.ruta_img}frontend/ic_yt.png"></a>
                                </div>
                    ...
                    <div class="footer-enlaces col-md-3">
                        ...
                        <div class="list-group">
                          <a href="http://www.iiap.org.pe/" class="list-group-item">
                            <h4 class="list-group-item-heading">IIAP</h4>
                            <!-- <p class="list-group-item-text">Breve descripcion del enlace</p> -->
                          </a>
                           <a href="http://www.sunedu.gob.pe/" class="list-group-item">
                            <h4 class="list-group-item-heading">SUNEDU</h4>
                            <!-- <p class="list-group-item-text">Breve descripcion del enlace</p> -->
                          </a>
                           <a href="#" class="list-group-item">
                            <h4 class="list-group-item-heading">CONCYTEC</h4>
                            <!-- <p class="list-group-item-text">Breve descripcion del enlace</p> -->
                          </a>
                           <a href="http://www.pronabec.gob.pe/" class="list-group-item">
                            <h4 class="list-group-item-heading">PRONABE</h4>
                            <!-- <p class="list-group-item-text">Breve descripcion del enlace</p> -->
                          </a>
                           <a href="http://dina.concytec.gob.pe/appDirectorioCTI/" class="list-group-item">
                            <h4 class="list-group-item-heading">DINA</h4>
                            <!-- <p class="list-group-item-text">Breve descripcion del enlace</p> -->
                          </a>
                           <a href="http://www.minedu.gob.pe/" class="list-group-item">
                            <h4 class="list-group-item-heading">Ministerio de Educación</h4>
                            <!-- <p class="list-group-item-text">Breve descripcion del enlace</p> -->
                          </a>
                        </div>
                    </div>
