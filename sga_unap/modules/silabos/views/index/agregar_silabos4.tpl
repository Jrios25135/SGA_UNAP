                        ...
                        <thead>
                            ...
                            <td>
                                ...
                                {for $sele=1;$sele<18;$sele++}
                                    <td><input type='checkbox' id='{$sele}' name='ct1semana{$sele}' value='semana{$sele}'></td>
                                {/for}
                                <td>
                            ...
                            <td>
                                ...
                                {for $sele=1;$sele<18;$sele++}
                                    <td><input type='checkbox' id='{$sele}' name='ct2semana{$sele}' value='semana{$sele}'></td>
                                {/for}
                                <td>
                            ...
                            <td>
                                ...
                                {for $sele=1;$sele<18;$sele++}
                                    <td><input type='checkbox' id='{$sele}' name='ct3semana{$sele}' value='semana{$sele}'></td>
                                {/for}
                                <td>
                            ...
                            {$contCapa=1}
                             {foreach item=rl from=$cap}
                                    ...
                                    {for $sele=1;$sele<18;$sele++}
                                    <td>
                                    <input type='checkbox' id='{$sele}' name='ct{($contCapa+3)}semana{$sele}' value='semana{$sele}'></td>
                                    {/for}
                                     <td>
