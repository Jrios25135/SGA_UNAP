        ...
        <div class="col-lg-10">
                    <div class="row">
                        ...
                        <div class="panel-heading">
                         ...
                         <textarea name="calif" class="form-control" id="calif" rows="16" placeholder="Escriba aquí" required>{$sil.Sil_Califacion}</textarea>
                          <div class="row panel-body">
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        <label for="img">Esquema de calificación:</label>
                                        <input type="file" class="form-control" name="img" id="img" accept="image/*"  value="{$sil.Sil_url_img}">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-10">
                    <div class="row">
                        ...
                        <textarea name="bib" class="form-control" id="bib" rows="16" placeholder="Escriba aquí..." required>{$sil.Sil_Bibliiografia}</textarea>
                        </div>
                    </div>
                </div>
