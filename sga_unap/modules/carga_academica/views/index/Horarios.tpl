            ...
            <div id="nuevo_rol" class="panel-body" style="width: 90%; margin: 0px auto">
                <form class="form-horizontal" data-toggle="validator" id="form3" role="form" name="form1" action="" method="post" >       
                    <div class="form-group">
                        <label class="col-lg-2 control-label">Hora Incio : </label>
                        <div class="col-lg-10">
                        ...
                        <table class="table" style="  margin: 20px auto">
                            ...
                            {foreach item=rl from=$listaDatos}
                                <tr {if $rl.Row_Estado==0}
                                    ...
                                    {if $_acl->permiso("editar_rol")}
                                    <td style=" text-align: center">
                                        <a data-toggle="tooltip" data-placement="bottom" class="btn btn-default btn-sm glyphicon glyphicon-refresh estado-registro" title="{$lenguaje.tabla_opcion_cambiar_est}" id_registro="{$rl.Hor_IdHorario}" estado="{$rl.Hor_Estado}"> </a>
                                        
                                        <a data-toggle="tooltip" data-placement="bottom" class="btn btn-default btn-sm glyphicon glyphicon-edit" title="{$lenguaje.tabla_opcion_editar_rol}" href="{$_layoutParams.root}{$_layoutParams.modulo}/{$_layoutParams.controlador}/editar{$formulario}/{$rl.Hor_IdHorario}"></a>
