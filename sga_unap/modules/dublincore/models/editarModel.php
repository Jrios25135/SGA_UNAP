...
class editarModel extends Model {
    ...
    public function editarTraduccion($Dub_Titulo, $Dub_Descripcion, $Dub_PalabraClave, $Dub_IdDublinCore, $Idi_IdIdioma) {
        ...
        $ContTradTitulo = $this->buscarCampoTraducido('dublincore', $Dub_IdDublinCore, 'Dub_Titulo', 'es');
        $ContTradDescripcion = $this->buscarCampoTraducido('dublincore', $Dub_IdDublinCore, 'Dub_Descripcion', 'es');
        $ContTradPalabraClave = $this->buscarCampoTraducido('dublincore', $Dub_IdDublinCore, 'Dub_PalabraClave', 'es');
