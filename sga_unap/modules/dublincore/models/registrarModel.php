...
//     public function getTematicasDublin($Idi_IdIdioma) {
//         $post = $this->_db->query(
//                 "SELECT Tem_Nombre
// FROM tematica ");
//         return $post->fetchAll();
...
//      public function getTematicaDublin($Tem_Nombre) {
//         $post = $this->_db->query(
//                 "SELECT tem.Tem_IdTematica
// FROM tematica tem
// WHERE Tem_Nombre = '$Tem_Nombre' ");
//         return $post->fetch();
//     }
...
WHERE dua.Dub_IdDublinCore = '$Dub_IdDublinCore' AND dua.Aut_IdAutor = '$Aut_IdAutor'");
    ...
    //   public function registrarTematicaDublin($Tem_Nombre) {
    //     $this->_db->prepare(
    //                     "insert into tematica (Tem_Nombre, row_estado) values " .
    //                     "(:Tem_Nombre, 1)"
    //             )
    //             ->execute(array(
    ...
    public function registrarDublinCore($Dub_Titulo, $Dub_Descripcion, $Dub_Editor, $Dub_Colabrorador, $Dub_FechaDocumento, $Dub_Formato, $Dub_Identificador, $Dub_Fuente, $Dub_Idioma, $Dub_Relacion, $Dub_Cobertura, $Dub_Derechos, $Dub_PalabraClave, $Tid_IdTipoDublin, $Arf_IdArchivoFisico, $Idi_IdIdioma, $Ted_IdTemaDublin) {
        $this->_db->prepare(
                        "insert into dublincore (Dub_Titulo, Dub_Descripcion, Dub_Editor, Dub_Colaborador, Dub_FechaDocumento, Dub_Formato, Dub_Identificador, Dub_Fuente, Dub_Idioma, Dub_Relacion, Dub_Cobertura, Dub_Derechos, Dub_PalabraClave, Tid_IdTipoDublin, Arf_IdArchivoFisico, Idi_IdIdioma, Ted_IdTemaDublin, Usu_IdUsuario, Dub_Estado ) values " .
                        "(:Dub_Titulo, :Dub_Descripcion, :Dub_Editor, :Dub_Colaborador, :Dub_FechaDocumento, :Dub_Formato, :Dub_Identificador, :Dub_Fuente, :Dub_Idioma, :Dub_Relacion, :Dub_Cobertura, :Dub_Derechos, :Dub_PalabraClave, :Tid_IdTipoDublin, :Arf_IdArchivoFisico, :Idi_IdIdioma, :Ted_IdTemaDublin, :Usu_IdUsuario, 1)"
                )
                ->execute(array(
    ...
    public function registrarDocumentosRelacionados($Dub_IdDublinCore) {
        $this->_db->prepare(
                        "insert into documentos_relacionados (Dub_IdDublinCore) values " .
                        "(:Dub_IdDublinCore)"
                )
                ->execute(array(
                    ':Dub_IdDublinCore' => $Dub_IdDublinCore
