                    ...
                    <div id='gestion_idiomas' style="margin:5px 20px"><input type="hidden" id="idiomaSelect" name="idiomaSelect" value="{$datos.Idi_IdIdioma}" />
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label for="palabras_claves" class="col-md-4 control-label">PalabraClave</label>
                                    <div class="col-md-6">        
                                ...
                                <div class="form-group">
                                    <label for="tipo_dublin" class="col-md-4 control-label">Tipo Dublin</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="tema_dublin" class="col-md-4 control-label">Tema de Dublin</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile" class="col-md-4 control-label">Nombre del Archivo</label>
                                    <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <label for="url" class="col-md-4 control-label">URL del Archivo</label>
                                    <div class="col-md-6">
