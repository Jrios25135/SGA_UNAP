...
class editarController extends Controller {
    ...
    public function index($registros = false) {
        ...
        // $metadatarecurso = $bdrecurso_model->getRecursoCompletoXid(53);
        ...
        $this->_view->assign('ficha', $this->_registrar->getFichaLegislacion('3', Cookie::lenguaje()));
    ...
    private function editarDublin($registros = false) {
            ...
            if (empty($archivo_fisico) || !empty($nombre_archivo) && $archivo_fisico['Arf_IdArchivoFisico'] == $this->getInt('Arf_IdArchivoFisico')) {
                ...
                //     if (!empty($pais)) {
                        ...
                        $this->_registrar->registrarDocumentosRelacionados($this->filtrarInt($registros));
