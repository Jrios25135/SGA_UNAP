<div  class="container-fluid" >
    <div class="row" style="padding-left: 1.3em; padding-bottom: 20px;">
        <h4 style="width: 80%;  margin: 0px auto; text-align: center;">Criterios de ficha de evaluación encuesta de alumnos</h4>
    </div>

    {if $_acl->permiso("agregar_rol")}
    <div class="panel panel-default">
        <div class="panel-heading jsoftCollap">
            <h3 aria-expanded="false" data-toggle="collapse" href="#collapse3" class="panel-title collapsed"><i style="float:right"class="fa fa-ellipsis-v"></i><i class="fa fa-user-secret"></i>&nbsp;&nbsp;<strong>NUEVO CRITERIO DE EVALUACION DE ENCUESTA</strong></h3>
        </div>
                ...
                <form class="form-horizontal" data-toggle="validator" id="form3" role="form" name="form1" action="" method="post" >  
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input class="form-control" id="nuevo_critero"  type="text" name="nuevo_criterio" placeholder="Entrega y revisa el sílabo en la primera " required="" />
                             </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <select class="form-control" name="tipos_criterio_evaluacion" id="tipos_criterio_evaluacion">
                             ...
                             <option value="{$tip.Tcv_IdTipoCriterioEvaluacionEncuesta|default:0}">{$tip.Tcv_Nombre}</option>
                                {/foreach}
                                {/if}
                            </select>
                        </div>                        
    ...
    <div class="panel panel-default">                             
        ...
        <div class="panel-body" style=" margin: 15px">
            ...
            <div id="listar_criterios_evaluacion_encuesta_administracion" >                
                {if isset($criterios_evaluacion_encuesta_administracion) && count($criterios_evaluacion_encuesta_administracion)}                
                    <div class="table-responsive">
                        <table class="table" style="  margin: 20px auto">
                            ...
                            {$contador=1}
                            {foreach item=cri from=$criterios_evaluacion_encuesta_administracion}
                                <tr {if $cri.Row_Estado==0}                                        
                                    ...
                                    <td>{$cri.Cee_Nombre}</td> 
                                    <td>{$cri.Tcv_Nombre}</td> 
                                    ...
                                    <td style=" text-align: center">
                                        <a data-toggle="tooltip" data-placement="bottom" class="btn btn-default btn-sm glyphicon glyphicon-refresh
                                         estado-criterio-evaluacion-encuesta"
                                          title="Cambiar estado" id_criterio="{$cri.Cee_IdCriterioEvaluacionEncuestaDocente}" estado="{$cri.Cee_Estado}"> </a>
                                        
                                        <a data-toggle="tooltip" data-placement="bottom" class="btn btn-default btn-sm glyphicon glyphicon-edit" title="Editar criterio" href="{$_layoutParams.root}evaluacion/index/editarCriterioEvaluacionEncuesta/{$cri.Cee_IdCriterioEvaluacionEncuestaDocente}"></a>
                                        ...
                                        {if $cri.Row_Estado==0}
                                            data-toggle="tooltip" 
                                            class="btn btn-default btn-sm  glyphicon glyphicon-ok confirmar-habilitar-criterio-evaluacion-encuesta" title="Habilitar" 
                                        {else}
                                            data-book-id="{$cri.Cee_Nombre}"
                                            data-toggle="modal"  data-target="#confirm-delete"
                                            class="btn btn-default btn-sm  glyphicon glyphicon-trash confirmar-eliminar-criterio-evaluacion-encuesta" title="Eliminar"
                                        {/if} 
                                        id_criterio="{$cri.Cee_IdCriterioEvaluacionEncuestaDocente}" data-placement="bottom" > </a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a style="cursor:pointer"  data-dismiss="modal" class="btn btn-danger danger eliminar_criterio_evaluacion_encuesta">Eliminar</a>
            </div>
        </div>
    </div>
</div>