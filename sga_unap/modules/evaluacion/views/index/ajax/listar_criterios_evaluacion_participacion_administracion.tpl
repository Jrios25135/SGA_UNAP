                        ...
                        <table class="table" style="  margin: 20px auto">
                            ...
                            {foreach item=cri from=$criterios_evaluacion_participacion_administracion}
                                <tr {if $cri.Row_Estado==0}                                        
                                    ...
                                    <td style=" text-align: center">
                                        <a data-toggle="tooltip" data-placement="bottom" class="btn btn-default btn-sm glyphicon glyphicon-refresh estado-criterio-evaluacion-participacion" title="Cambiar estado" id_criterio="{$cri.Cep_IdCriterioEvaluacionParticipacionDocente}" estado="{$cri.Cep_Estado}"> </a>
