        ...
        <div class="panel panel-default">
            ...
            <div id="nuevo_criterio" class="panel-body" style="width: 90%; margin: 0px auto">
                <form class="form-horizontal" data-toggle="validator" id="form3" role="form" name="form1" action="" method="post" >
                    <input type="hidden" id="id_criterio" name="id_criterio" value="{$datos.Cee_IdCriterioEvaluacionEncuestaDocente}" />                    
                    <div class="form-group">
                        <label class="col-lg-2 control-label">Criterio: </label>
                        <div class="col-lg-10">
                            <input class="form-control"  value="{$datos.Cee_Nombre}" id="criterio"  type="text" name="criterio" placeholder="Criterio" required="" />
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6 col-sm-2 col-lg-offset-2 col-lg-2">
                            <button class="btn btn-success" type="submit" id="bt_editar_criterio_evaluacion_encuesta" name="bt_editar_criterio_evaluacion_encuesta" ><i class="glyphicon glyphicon-floppy-disk"> </i>&nbsp; Guardar</button>
                        </div>
