...
class registrarModel extends Model
{
    ...
    {
        $post = $this->_db->query("SELECT Pai_IdPais FROM pais
WHERE Pai_Nombre = '$Pai_Nombre' ");				
    ...
    {
        $post = $this->_db->query("SELECT Nil_IdNivelLegal FROM nivel_legal
WHERE fn_TraducirContenido('nivel_legal','Nil_Nombre',Nil_IdNivelLegal,'$Idi_IdIdioma',Nil_Nombre) = '$condicion' ");				
        return $post->fetch();
    }
	
	public function getSubNivelLegal($idnivellegal,$subnivellegal,$Idi_IdIdioma)
    {
        $post = $this->_db->query("SELECT * FROM sub_nivel_legal snl
WHERE snl.Nil_IdNivelLegal = $idnivellegal AND fn_TraducirContenido('sub_nivel_legal','Snl_Nombre',snl.Snl_IdSubNivelLegal,'$Idi_IdIdioma',snl.Snl_Nombre) = '$subnivellegal'");				
        return $post->fetch();
    }
	
	public function getTemaLegal($idsubnivellegal,$temalegal,$Idi_IdIdioma)
    {
        $post = $this->_db->query("SELECT * FROM tema_legal tel
WHERE tel.Snl_IdSubNivelLegal = $idsubnivellegal AND fn_TraducirContenido('tema_legal','Tel_Nombre',tel.Tel_IdTemaLegal,'$Idi_IdIdioma',tel.Tel_Nombre) = '$temalegal'");				
        return $post->fetch();
    }
...
WHERE fn_TraducirContenido('tipo_legal','Til_Nombre',Til_IdTipoLegal,'$Idi_IdIdioma',Til_Nombre) = '$Til_Nombre'");				
    ...
    {
        $post = $this->_db->query("SELECT * FROM cuenca cue
WHERE cue.Cue_Nombre = '$cuenca' ");				
        return $post->fetch();
    }
	
	public function getSubCuenca($idcuenca,$subcuenca)
    {
        $post = $this->_db->query("SELECT * FROM sub_cuenca suc
WHERE suc.Cue_IdCuenca = $idcuenca AND suc.Suc_Nombre = '$subcuenca' ");				
        return $post->fetch();
    }
...
WHERE rio.Pai_IdPais = $idpais AND rio.Rio_Nombre = '$rio' ");				
        return $post->fetch();
    }
...
WHERE esm.Esm_Latitud = '$Esm_Latitud' and esm.Esm_Longitud = '$Esm_Longitud' ");				
    ...
    {
        $post = $this->_db->query("SELECT * FROM variables_estudio var
WHERE var.Var_Nombre = '$variable' ");				
        return $post->fetch();
    }
    ...
    {
        $post = $this->_db->query("SELECT * FROM autor
WHERE autor.Aut_Nombre = '$autor' ");				
        return $post->fetch();
    }
    ...
    {
        $post = $this->_db->query("SELECT * FROM tema_dublin ted
WHERE fn_TraducirContenido('tema_dublin','Ted_Descripcion',ted.Ted_IdTemaDublin,'$Idi_IdIdioma',ted.Ted_Descripcion) = '$temadublin' ");				
        return $post->fetch();
    }
	
	public function getTipoDublin($tipodublin = "",$Idi_IdIdioma)
    {
        $post = $this->_db->query("SELECT * FROM tipo_dublin tid
WHERE fn_TraducirContenido('tipo_dublin','Tid_Descripcion',tid.Tid_IdTipoDublin,'$Idi_IdIdioma',tid.Tid_Descripcion) = '$tipodublin' ");				
        return $post->fetch();
    }
	
	public function getDublinAutor($dublin, $autor)
    {
        $post = $this->_db->query("SELECT * FROM dublincore_autor dua
WHERE dua.Dub_IdDublinCore = $dublin AND dua.Aut_IdAutor= $autor");				
        return $post->fetch();
    }
	
	public function getDublinCore($titulo, $tid_dublin)
    {
        $post = $this->_db->query("SELECT * FROM dublincore dub
WHERE dub.Dub_Titulo = '$titulo' AND dub.Tid_IdTipoDublin = $tid_dublin ");				
        return $post->fetch();
    }
