...
<div class="container" style="margin:10px auto;">
    <div class="row">
        ...
        <div class="col-md-9">        
            <div class="panel panel-default">
                <div class="panel-heading"><strong> CARGAR ARCHIVO {if $tipo_estandar==3}- VARIABLES{/if}</strong></div>
                <div class="panel-body">  
                    <div role="tabpanel">
                        <!-- Nav tabs -->
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="excel">
                                <div style="margin:10px auto;" align="center">
                                    <form  action="../../registrar/excel" method="post" data-toggle="validator" class="form-horizontal" role="form" enctype="multipart/form-data" id="subir_archivo">
                            ...
                            <div role="tabpanel" class="tab-pane" id="txt">
                                <div style="margin:10px auto;" align="center">
                                    <form action="../../registrar/txt/" method="post" enctype="multipart/form-data" class="form-horizontal" data-toggle="validator" role="form" id="subir_archivo">
                                        <div class="form-group">
                                        	<div class="col-md-12">
                                        		<input type="file" name="archivo" id="archivo">
                                                {if $estandar==3}
            ...
            {if $tipo_estandar==2}  
                <div class="panel panel-default">
                    <div class="panel-heading"><strong> CARGAR ARCHIVO {if $tipo_estandar==3}- DATA{/if}</strong></div>
                    <div class="panel-body">  
                        <div role="tabpanel">
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs" role="tablist">
